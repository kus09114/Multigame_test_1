...
public class PlayerProfileMenu : Panel
{
	...
	private async void AddFriend()
    {
		...
		{
			ErrorMenu panel = (ErrorMenu)PanelManager.GetSingleton("error");
			panel.Open(ErrorMenu.Action.None, "Friend to send the friend request.", "OK");
	...
	private async void RemoveFriend()
	{
		...
		{
			ErrorMenu panel = (ErrorMenu)PanelManager.GetSingleton("error");
			panel.Open(ErrorMenu.Action.None, "Friend to remove the player from your friends list.", "OK");
		}
